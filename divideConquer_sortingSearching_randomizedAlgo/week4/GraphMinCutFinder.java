...
/*
 * Brazenly copied from https://github.com/lisalisadong/
 * algorithms-design-and-analysis/blob/master/graph/karger-minimum-cut/Graph.java 
 */
...
public class GraphMinCutFinder {
	
	private Hashtable<Integer, Vertex> vertices;
	private ArrayList<Edge> edges;
	private String inputFileName;
	
	public GraphMinCutFinder(String inputFileName) throws FileNotFoundException{
	...
	public int findMinCut() throws FileNotFoundException{
		...
		for (int i = 0; i < nRepeat; i++){
			GraphMinCutFinder g = new GraphMinCutFinder(this.inputFileName);
			g.randomContract();
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		GraphMinCutFinder g = new GraphMinCutFinder("data/kargerMinCut.txt");
